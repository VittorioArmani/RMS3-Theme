...
<div id="properties">
  ...
  <p style="font-size:20px; text-align:left; color:black; margin-top:20px; padding-left:15px">Features:</p>
  <?php /*
...
<div class="tab">
  <button class="tablinks active" onclick="openCity(event, 'London')">Item Information</button>
