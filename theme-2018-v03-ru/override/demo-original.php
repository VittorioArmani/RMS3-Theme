    ...
    <div id="preview-bar">
        <ul id="bar-inner" style="max-width:1400px!important">
            ...
            <li class="block inner">
                <a class="btn2 fancybox order" href="#request-form-wrapper" data-id="//www.templatehelp.com/preset/pr_preview.php?i=<?php echo $template->getId() ?>&pr_code=<?php echo PR_CODE ?>">Заказать сайт</a>
            </li>
            <?php } else { ?>
            <li class="block inner">
            ...
            <li class="block inner"><a href="<?php echo htmlentities($template->getBuyUrl())?>" class="btn">Купить шаблон</a></li>
            <?php } ?>
        ...
        <div id="preview-wrapper" class="hide_wrap">
            ...
            <?php
                ...
                <div class="technical-problems">
                    ...
                    <p class="problems-message">Демо этого шаблона будет доступно примерно через 5-6 часов.</p>
                    <p>
                        <a href="<?php echo($template->type->getUrl()); ?>">Вернуться к выбору дизайна</a>
                    </p>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="popup_cnt" >
            ...
            <form id="request-form">
                <fieldset>
                    ...
                    <input type="text" name="phone" class="input-phone" placeholder="Ваш телефон:">
                    <input type="submit" value="Отправить" class="btn2 send-button">
                    <div class="confirm-block">
                        <input type="checkbox" name="form_checked" id="form_checked">
                        <span class="text-confirm">Я согласен с <a href="<?php echo S_SITE_URL ?>privacy-policy/" target="_blank">политикой конфиденциальности</a></span>
                    </div>
