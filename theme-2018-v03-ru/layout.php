...
<html lang="ru_RU">
    <head>
        ...
        <!-- <title><?php //echo (META_TITLE == true)? META_TITLE : "Интернет-магазин шаблонов"; ?></title> -->
        <!-- <title><?php echo $page->getHtmlTitle() . '&nbsp'; echo (META_TITLE) ? META_TITLE : "Интернет-магазин шаблонов"; ?> </title> -->
        ...
        if ( WHERE_WE_NOW == 'preview' ) {
            ...
            $url = 'https://api.templatemonster.com/products/v2/products/ru?language=ru&ids=' . $template->getId() . '&expand=properties';
                                ...
                                <div class="rd-navbar-subpanel">
                                    <div class="rd-navbar-nav-wrap">
                                        ...
                                        <ul class="rd-navbar-nav">
    										...
    										<li>
                                                <a href="<?php echo S_SITE_URL ?>privacy-policy/">Политика конфиденциальности</a>
                                            </li>
                                          	<li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <li data-equal-group="1">
                            <div class="poligon-4">
                                ...
                                <h5>1 200 000+<br/> довольных <br/>клиентов</h5>
                            </div>
                        </li>
                    </div>
                </div>
