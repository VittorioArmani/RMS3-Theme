    ...
    <div id="preview-bar">
        <ul id="bar-inner">
            ...
            <li class="block inner">
                <a class="btn2 fancybox order" href="#request-form-wrapper" data-id="https://www.templatehelp.com/preset/pr_preview.php?i=<?php echo $template->getId() ?>&pr_code=<?php echo PR_CODE ?>">Заказать сайт</a>
            </li>
            <?php } else { ?>
