...
<section style="padding-top:30px" class="well <?php if (WEBSTUDIO == 'true') {
    ...
    <div id="templates_block" class="container">
        <!--<h2>Шаблоны 1<?php echo $catalog->getName(); ?> "<?php echo $catalog->getVisibleName() ?>"</h2>-->
        <div class="row">
            ...
            <?php if (isset($similar)) {
                $templates_params['message'] = 'По запрошеным критерим шаблоны не найдены<br/>Пожалуйста, просмотрите подобные шаблоны';
            } ?>
