<div class="pager">
    <?php if (isset($first_page)) {?>
        <a href="<?php echo SITE_DOMAIN?><?php echo $prev_page_url?>" class="prev-pager">Precedente</a>&nbsp;
    <?php } ?>
    ...
    <?php if (isset($last_page)) {?>
        <a href="<?php echo SITE_DOMAIN?><?php echo $next_page_url?>" class="next-pager">Prossima﻿</a>&nbsp;
    <?php } ?>
</div>