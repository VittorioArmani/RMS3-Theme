...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' && strpos($previewUrl, 'http://') !== false){
$symbol = strpos($previewUrl, '?')? '&' : '?';
header("Location:" . $previewUrl . $symbol . 'i=' . $template_id . '&pr_code=' . PR_CODE, true, 302);	
}
...
<html lang="en">
<head>
    <title><?php echo $title ?> <?php echo (META_TITLE) ? META_TITLE : "| Template Shop Online"; ?></title>
    ...
    <div id="preview-bar">
        <ul id="bar-inner">
            ...
            <li class="block inner">
                ...
                <a class="btn2 fancybox order" href="#request-form-wrapper" data-id="https://www.templatehelp.com/preset/pr_preview.php?i=<?php echo $template->getId() ?>&pr_code=<?php echo PR_CODE ?>">
Ordina un sito web</a>
            </li>
            <?php } else { ?>
        ...
        <div id="preview-wrapper" class="hide_wrap">
            ...
            <?php
                ...
                <div class="technical-problems">
                    ...
                    <p class="problems-message">La live demo di questo modello sarà disponibile entro 5-6 ore.</p>
                    <p>
                        <a href="<?php echo($template->type->getUrl()); ?>">Torna alla galleria dei modelli</a>
                    </p>
                </div>
            <?php } ?>
        </div>
