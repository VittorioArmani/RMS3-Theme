    ...
    <div class="popup" id="request-form-wrapper" style="display: none;">
        <div class="popup_cnt" >
            ...
            <form id="request-form">
              <fieldset>
                <input type="text" name="name" class="input-name" placeholder="Il tuo nome">
                <input type="text" name="email" class="input-email" placeholder="E-mail">
                <input type="text" name="phone" class="input-phone" placeholder="Il tuo numero">
                <input type="submit" value="Invia" class="btn2 send-button">
                  <div class="confirm-block">
                    <input type="checkbox" name="form_checked" id="form_checked">
                    <span class="text-confirm">Ho letto e accetto la <a href="<?php echo S_SITE_URL ?>privacy-policy/" target="_blank">Informativa sulla Privacy</a></span>
                  </div>
