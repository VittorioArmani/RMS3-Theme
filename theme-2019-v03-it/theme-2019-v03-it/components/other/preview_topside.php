...
<section class="well3">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="TemplateMin"><?php echo "Modello #";echo $template->getId(); ?></li>
        </ul>
                ...
                <?php } else { ?>
                    <div class="buy_template">
                        ...
                        <table id="table-mobile" class="table" style="border:none; text-align:left;">
                            <tr>        
                                <td class="TemplateMin" style="border-top:none">"Modello #"
                            ...
                            <tr> 
                                <td class="TemplateMin">Autore:</td>
                    ...
                    <span>
                        ...
                        <div id="templateInfo" style="margin-top:20px">
                            ...
                            <tr>        
                                <td class="TemplateMin" style="border-top:none"><span class="TemplateMin">Modello #</span>
                                <?php echo $template->getId() ?></td>
                            </tr>
                            <tr>        
                                <td class="TemplateMin"><span class="TemplateMin">Tipo:</span>
                                <b><u>
                                <!--<a href="<?php //echo $template->package->getUrl()?>"><?php // echo $template->package->getVisibleName() ?></a>-->
                                <a href="<?php echo $template->type->getUrl(); ?>"><?php echo $template->type->getVisibleName(); ?></a>
                                </u></b></td>
                            ...
                            <tr> 
                                <td class="TemplateMin"><span class="TemplateMin">Autore:</span>
