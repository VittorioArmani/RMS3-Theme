...
<section style="padding-top:30px" class="well <?php if (WEBSTUDIO == 'true') {
    ...
    <div id="templates_block" class="container">
        <!-- <h2>Modelli trovati in <?php // echo $catalog->getName(); ?> "<?php // echo $catalog->getVisibleName() ?>"</h2> -->
        <div class="row">
            ...
            <?php if (isset($similar)) {
                $templates_params['message'] = 'NESSUN ELEMENTO TROVATO CORRISPONDENTE AI TUOI CRITERI DI RICERCA<br> Si prega di visionare dei modelli simili﻿';
            } ?>
