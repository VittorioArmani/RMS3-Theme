...
$translator_base_url = 'https://www.googleapis.com/language/translate/v2?key=your_API_key_here&source=it&target=en';
...
$keyword = str_replace(" ","%20",$keyword);
  ...
  if(function_exists('curl_init')) {
    ...
    Header ("Location: /it/search/?busqueda=$busqueda&type=$type&category=$category&price1=$price1&price2=$price2&number=$number&keyword=$traduccion");
        ob_end_flush();
    ob_clean();
    exit();
  } else {
